<template>
    <div class="roehre">
        ...
        <InfoCard variant="orange" :title="'Kapitel 2: Röhre'" :showTime="'🕑 30-35 Minuten'"
            ...
            <p>Im letzten Kapitel haben wir das Springen der Figur implementiert.</p>
                ...
                <div class="horizontal-container">
                    <div class="vertical-container exercise-container">
                        ...
                        <OpenIFrameButton :projectUrl="SprungProjectUrl" :type="'editor'" :buttonTitle="'Editor Öffnen'"
                            ...
                            :hints="content.modify.hints" :images="[rohr_img]" />
...
`
    ...
    modify: {
        ...
        vorbereitung: ['Übertrage den Code rechts in <code>Röhre1</code> und <code>Röhre2</code>. Drücke dafür <b>unten rechts</b> auf die jeweilige Figur'],
        aufgabe_a: [
            'Such den Block <code>Zufallszahl von 1 bis 10</code> im Abschnitt <b>Operatoren</b>.',
            'Verändere die Werte so, dass Zufallszahlen zwischen <code> -25 und 50 </code> ausgewählt werden.',
            'Verändere den Block <code> gehe zu x: 250 y: 0 </code>so, dass die <code> y</code> nicht mehr <code> 0</code> ist, sondern die Zufallszahl.',
            'Platziere das zweite Rohr im Abstand von genau 250 Pixeln zum ersten Rohr, wenn die grüne Flagge gedrückt wird!'
        ],
        hints: [
            {
                title: "d) Hinweis",
                content: "Ziehe den Block <code>Zufallszahl von a bis b </code> dort hin, wo <code> y: 0 </code> ist."
            },
            {
                title: "e) Hinweis",
                content: "Verändere im Block <code> gehe zu x: 250, y: 0</code> das <code> x </code>. x-Werte gehen in Scratch nur von -250 bis 250!"
            },
        ]
    },
    make: {
