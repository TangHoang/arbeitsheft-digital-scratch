    ...
    <div class="einleitung">
        ...
        <InfoCardWhite :title="'Bühne und Bühnenbilder'">
            ...
            <ul>
                ...
                <li> Die Bühne kann eigene Skripte und Klänge haben (z. B. Szene wechseln, Spielzustand steuern). </li>
            </ul>
            <p>Koordinatensystem: Die Mitte der Bühne ist (0, 0), x von −240 bis 240, y von −180 bis 180. Sprites
                bewegen sich in diesem Bereich.</p>
        </InfoCardWhite>
        ...
        <InfoCardPurple :title="'Bedingungen'">
            ...
            <ul>
                ...
                <li><b>falls &lt;Bedingung&gt; dann sonst:</b> führt entweder den „dann“-Teil oder den „sonst“-Teil aus.
                </li>
            </ul>
            <p>Beispiel: „Falls Figur den Rand berührt, dann pralle ab, sonst gehe 10 Schritte.“</p>
        </InfoCardPurple>
